<?php
/**
 * GraphQL Object - SEOSocialLinkedIn
 *
...
/**
 * Class - SEOSocialLinkedIn
 */
class LinkedIn implements Registrable, Type, TypeWithFields {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SEOSocialLinkedIn';
