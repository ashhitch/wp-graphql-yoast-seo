<?php
/**
 * GraphQL Object - SEOSocialYoutube
 *
...
/**
 * Class - SEOSocialYoutube
 */
class Youtube implements Registrable, Type, TypeWithFields {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SEOSocialYoutube';
