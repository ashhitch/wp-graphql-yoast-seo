<?php
/**
 * GraphQL Object - SEOSocialInstagram
 *
...
/**
 * Class - SEOSocialInstagram
 */
class Instagram implements Registrable, Type, TypeWithFields {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SEOSocialInstagram';
