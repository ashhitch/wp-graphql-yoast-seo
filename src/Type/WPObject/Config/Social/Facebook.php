<?php
/**
 * GraphQL Object - SEOSocialFacebook
 *
...
/**
 * Class - SEOSocialFacebook
 */
class Facebook implements Registrable, Type, TypeWithFields {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SEOSocialFacebook';
