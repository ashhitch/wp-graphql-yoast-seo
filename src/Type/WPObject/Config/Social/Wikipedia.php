<?php
/**
 * GraphQL Object - SEOSocialWikipedia
 *
...
/**
 * Class - SEOSocialWikipedia
 */
class Wikipedia implements Registrable, Type, TypeWithFields {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SEOSocialWikipedia';
