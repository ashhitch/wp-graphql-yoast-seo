<?php
/**
 * GraphQL Object - SEOSocialTwitter
 *
...
use WPGraphQL\YoastSEO\Type\Enum\SEOCardTypeEnum;

/**
 * Class - SEOSocialTwitter
 */
class Twitter implements Registrable, Type, TypeWithFields {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SEOSocialTwitter';
	...
	public static function get_fields() : array {
		...
		return [
			...
			'cardType' => [ 'type' => SEOCardTypeEnum::$type ],
		];
	}
}
